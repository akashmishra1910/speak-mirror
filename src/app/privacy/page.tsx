      ...
      >
        ...
        <div className="border-b border-slate-200 dark:border-white/10 pb-8 mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-xs font-semibold text-slate-500 dark:text-zinc-400 uppercase tracking-widest">Privacy Compliance</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold text-themeText dark:text-white mb-4 tracking-tight">Privacy Policy</h1>
        ...
        <div className="space-y-10 text-slate-700 dark:text-zinc-300 font-light leading-relaxed text-sm md:text-base">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-themeText dark:text-white mb-4 flex items-center gap-2 font-mono">
              <span className="text-slate-500 dark:text-zinc-500 text-sm font-mono">01.</span> Information We Collect
            </h2>
            <p className="mb-3">
              To deliver our AI-powered communication diagnostics, we collect:
            </p>
            <ul className="list-disc list-inside ml-4 space-y-1 text-slate-650 dark:text-zinc-400">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-themeText dark:text-white mb-4 flex items-center gap-2 font-mono">
              <span className="text-slate-500 dark:text-zinc-500 text-sm font-mono">02.</span> How We Process Your Speech
            </h2>
            <p>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-themeText dark:text-white mb-4 flex items-center gap-2 font-mono">
              <span className="text-slate-500 dark:text-zinc-500 text-sm font-mono">03.</span> Session Isolation & Cookie Security
            </h2>
            <p className="mb-4">
            ...
            <div className="bg-slate-100/50 dark:bg-white/[0.02] border border-slate-200/60 dark:border-white/5 p-5 rounded-2xl flex gap-4 items-start">
              ...
              <div className="text-sm">
                <ul className="list-disc list-inside space-y-1 text-slate-650 dark:text-zinc-300">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-themeText dark:text-white mb-4 flex items-center gap-2 font-mono">
              <span className="text-slate-500 dark:text-zinc-500 text-sm font-mono">04.</span> Data Retention & Deletion
            </h2>
            <p>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-themeText dark:text-white mb-4 flex items-center gap-2 font-mono">
              <span className="text-slate-500 dark:text-zinc-500 text-sm font-mono">05.</span> Third-Party Subprocessors
            </h2>
            <p>
          ...
          <section className="border-t border-slate-200 dark:border-white/10 pt-10">
            <h2 className="text-lg font-bold text-themeText dark:text-white mb-2">Exercising Your GDPR / Privacy Rights?</h2>
            <p className="text-slate-650 dark:text-zinc-400">
              Please email our data protection officer at{" "}
              <a href="mailto:privacy@speakmirror.com" className="text-indigo-600 dark:text-white underline hover:text-indigo-550 dark:hover:text-zinc-300 transition-colors">
