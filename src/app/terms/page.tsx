...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-16 md:py-24 relative z-10">
      ...
      <Link 
        href="/" 
        className="inline-flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-themeText dark:text-white/60 dark:hover:text-white mb-8 transition-all cursor-pointer"
      >
      ...
      >
        ...
        <div className="border-b border-slate-200 dark:border-white/10 pb-8 mb-12">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-sky-500/10 border border-sky-500/20 text-sky-600 dark:bg-white/5 dark:border-white/10 dark:text-zinc-300 flex items-center justify-center shadow-[0_0_15px_rgba(255,255,255,0.02)]">
              <FileText className="w-5 h-5" />
            </div>
            <span className="text-xs font-semibold text-slate-500 dark:text-zinc-400 uppercase tracking-widest">Legal Documentation</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold text-themeText dark:text-white mb-4 tracking-tight">Terms of Service</h1>
          <p className="text-slate-500 dark:text-foreground/40 text-sm font-mono">Last Updated: May 27, 2026</p>
        </div>

        {/* Content Layout */}
        <div className="space-y-10 text-slate-700 dark:text-zinc-300 font-light leading-relaxed text-sm md:text-base">
          <p className="text-slate-650 dark:text-zinc-400 italic">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-themeText dark:text-white mb-4 flex items-center gap-2 font-mono">
              <span className="text-slate-500 dark:text-zinc-500 text-sm font-mono">01.</span> Acceptance of Terms
            </h2>
            <p>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-themeText dark:text-white mb-4 flex items-center gap-2 font-mono">
              <span className="text-slate-500 dark:text-zinc-500 text-sm font-mono">02.</span> Description of Service
            </h2>
            <p>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-themeText dark:text-white mb-4 flex items-center gap-2 font-mono">
              <span className="text-slate-500 dark:text-zinc-500 text-sm font-mono">03.</span> Account Registration & Security
            </h2>
            <p className="mb-4">
            ...
            <div className="bg-slate-100/50 dark:bg-white/[0.02] border border-slate-200/60 dark:border-white/5 p-5 rounded-2xl flex gap-4 items-start">
              <ShieldAlert className="w-5 h-5 text-indigo-600 dark:text-indigo-400 shrink-0 mt-0.5" />
              <div className="text-sm text-slate-650 dark:text-zinc-300">
                <strong className="text-themeText dark:text-white block mb-1">Session Security Notice</strong>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-themeText dark:text-white mb-4 flex items-center gap-2 font-mono">
              <span className="text-slate-500 dark:text-zinc-500 text-sm font-mono">04.</span> Workspaces & Collaboration
            </h2>
            <p>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-themeText dark:text-white mb-4 flex items-center gap-2 font-mono">
              <span className="text-slate-500 dark:text-zinc-500 text-sm font-mono">05.</span> User Content & AI Diagnostics
            </h2>
            <p>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-themeText dark:text-white mb-4 flex items-center gap-2 font-mono">
              <span className="text-slate-500 dark:text-zinc-500 text-sm font-mono">06.</span> Prohibited Activities
            </h2>
            <p>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-themeText dark:text-white mb-4 flex items-center gap-2 font-mono">
              <span className="text-slate-500 dark:text-zinc-500 text-sm font-mono">07.</span> Disclaimers & Limitation of Liability
            </h2>
            <p>
          ...
          <section className="border-t border-slate-200 dark:border-white/10 pt-10">
            <h2 className="text-lg font-bold text-themeText dark:text-white mb-2">Have questions about these terms?</h2>
            <p className="text-slate-650 dark:text-zinc-400">
              Reach out to our compliance team at{" "}
              <a href="mailto:support@speakmirror.com" className="text-indigo-600 dark:text-white underline hover:text-indigo-550 dark:hover:text-zinc-300 transition-colors">
