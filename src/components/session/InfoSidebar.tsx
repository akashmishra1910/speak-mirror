...
export function InfoSidebar({
  ...
  return (
    <aside className="w-full flex flex-col gap-5 text-left p-4 lg:p-5 bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl border border-white/50 dark:border-white/5 rounded-[2rem] transition-all duration-300 ease-out hover:shadow-lg min-h-[450px] h-auto shadow-sm overflow-hidden [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
